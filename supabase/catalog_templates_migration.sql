...
BEGIN
  ...
  INSERT INTO public.unit_templates (name, base_unit) VALUES ('Cigarrillos Tradicional', 'cigarrillo') RETURNING id INTO cig_template_id;
  
  INSERT INTO public.template_units (template_id, unit_name, conversion_factor, hierarchy_level) VALUES
    (cig_template_id, 'Pallet', 300000, 0), -- 60 cajas * 5000
    (cig_template_id, 'Caja', 5000, 1),     -- 25 cartones * 200
    (cig_template_id, 'Cartón', 200, 2),    -- 10 atados * 20
    (cig_template_id, 'Unidad (Atado)', 20, 3);
    
  -- Plantilla Papeles
  INSERT INTO public.unit_templates (name, base_unit) VALUES ('Papeles Estándar', 'hoja') RETURNING id INTO pap_template_id;
  
  INSERT INTO public.template_units (template_id, unit_name, conversion_factor, hierarchy_level) VALUES
    (pap_template_id, 'Caja', 125000, 0),   -- 100 blisters * 1250
    (pap_template_id, 'Blister', 1250, 1),  -- 25 libros * 50
    (pap_template_id, 'Libro', 50, 2);
